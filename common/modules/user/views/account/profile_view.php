...
<div class="breadcrumbs hide-on-small-only">
    <div class="container">
        <div class="col s12">
            <ul class="clearfix">
                <li class="active"><?= $account->first_name ?>'s profile</li>
                <li>→</li>
                <li><a href="/">main</a></li>
            </ul>
        </div>
                ...
                <aside>
                    <div class="bordered-box main-profile">
                        <div class="preview-info clearfix">
                            <div class="bookmark">
                                <a href="javascript:void(0)" onclick="addToBookmarks(2,<?= $account->id ?>)"><img src="/images/bookmark.svg" alt="add to bookmarks"></a>
                            </div>
                            <?php if ($is_premium) : ?>
                        ...
                        <div class="center pf-marg">
                            <div class="profile-title">
                                <a href="#"><?= $account->first_name ?>&nbsp;<?= $account->last_name ?></a><span class="badge black online">online</span>
                            </div>
                        </div>
                        <div class="center pf-marg">
...
<!--                            </a>-->
                        ...
                        <div class="profile-info-wrap">
                            <?php if($account->isFollowed): ?>
                                <a href="javascript:void(0)" onclick="Profile.toggleFollow(<?= $account->user_id ?>, this)" class="btn-large waves-effect" style="display: block; margin: 0 auto 10px auto;">unfollow</a>
                            <?php else: ?>
                                <a href="javascript:void(0)" onclick="Profile.toggleFollow(<?= $account->user_id ?>, this)" class="btn-large btn-gray waves-effect" style="display: block; margin: 0 auto 10px auto;">follow</a>
                            <?php endif; ?>
...
<!--                        </ul>-->
            ...
            <div class="col s12 m12 l8 profile-content">
                ...
                <div class="garage-wrap">
                    ...
                    <a href="<?= Url::to(['/garage/car/view', 'id' => $_GET['id']]) ?>" class="btn-large btn-gray waves">view garage</a>
                </div>
                <?= $this->render('../../../blog/views/blog/blog', ['account' => $account, 'posts' => $posts, 'mainCar' => $mainCar, 'avatar' => $avatar]) ?>
            </div>
        </div>
    </div>
</div>
