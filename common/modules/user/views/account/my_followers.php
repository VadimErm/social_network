                    ...
                    <div class="bordered-box main-profile">
                        ...
                        <div class="profile-info-wrap">
                            <div class="profile-info-row clearfix">
                                followers
                                <span class="stat-counter"><a href="<?= Url::to(['/user/account/my-followers']) ?>">100</a></span>
                            </div>
                            <div class="profile-info-row clearfix">
                                users follows
            ...
            <div class="col s12 m12 l8 followers-content">
                ...
                <div id="following">
                    ...
                    <div class="fuser-row clearfix">
                        ...
                        <div class="u-body">
                            <a href="#unfollow" class="btn-large  waves-effect popup-form">unfollow</a>
                            <a href="#" class="bolder">Aahil Asad</a>
                            <div class="city">
                                UAE, Dubai
                            </div>
                ...
                <div id="follow">
                    ...
                    <div class="fuser-row clearfix">
                        ...
                        <div class="u-body">
                            <a href="#unfollow" class="btn-large btn-gray waves-effect popup-form">unfollow</a>
                            <a href="#" class="bolder">Aahil Asad</a>
                            <div class="city">
                                UAE, Dubai
                            </div>
...
<!-- /Confirm wrapper -->
<form id="unfollow" class="white-popup-block dialog-pop mfp-hide">
    <div class="heading">
    ...
    <div class="dialog-popup center">
        <h6>Unfollow</h6>
        <p>Are you sure?</p>
        <a href="#" id="unfollow-button" class="btn-large waves-effect">Yes</a>
        <a href="#" id="cancel-unfollow" class="btn-large btn-gray waves-effect modal-close">cancel</a>
    </div>
</form>