...
<?php $this->beginPage() ?>
    ...
    <!-- User navigation -->
    <?php if ($isGuest) : ?>
        <div id="slide-out" class="side-nav right-aligned" style="transform: translateX(100%);">
            ...
            <div class="user-nav-menu">
                <ul>
                    ...
                    <li><a href="#">Messages</a><div class="user-badge">1</div></li>
                    <li><a href="#">Journals</a><div class="user-badge">1</div><div class="user-badge"><span class="ico-heart-outline"></span>23</div></li>
                    <li><a href="#">Photos</a><div class="user-badge">1</div><div class="user-badge"><span class="ico-heart-outline"></span>23</div></li>
                    <li><a href="#">Achievements</a><div class="user-badge">1</div><div class="user-badge"><span class="ico-heart-outline"></span>23</div></li>
                    <li><a href="#">Subscriptions</a><div class="user-badge">1</div></li>
                    <li><a href="#">Bookmarks</a><div class="user-badge">1</div></li>
                    <li><a href="#">Notifications</a><div class="user-badge">1</div></li>
