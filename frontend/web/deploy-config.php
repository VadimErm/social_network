 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', '123qweasdzxc');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'http://git.nevera.space/Nevera.Space/ARBA.AE.git');
 ...
 */
define('TARGET_DIR', '/home/arba/public_html/ARBA.AE');
